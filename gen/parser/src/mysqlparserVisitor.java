...
public interface mysqlparserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link mysqlparser#valueRow}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitValueRow(mysqlparser.ValueRowContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link mysqlparser#identitySpec}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIdentitySpec(mysqlparser.IdentitySpecContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link mysqlparser#identifierOrFunction}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIdentifierOrFunction(mysqlparser.IdentifierOrFunctionContext ctx);
	/**
